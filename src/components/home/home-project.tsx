            ...
            <div className="container sticky max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8 max-h-full">
                ...
                <div className="mx-auto lg:max-w-full max-w-2xl lg:mx-0">
                    <div className="flex lg:justify-between w-full">
                        ...
                        <div className="flex justify-end w-full">
                            <Link href="/blog" className="text-gray-300 font-semibold hover:text-gray-400">
                                View all
                            </Link>
                        </div>
                    </div>
                ...
                <div className="mx-auto mt-4 grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 sm:mt-5 sm:pt-5 lg:mx-0 lg:max-w-none lg:grid-cols-3">
                    {Data.slice(0,3).map((project, index) => {
                        return (
                            <div key={index} className="group relative rounded-lg bg-slate-50 hover:bg-slate-200 p-3 hover:drop-shadow-2xl">
